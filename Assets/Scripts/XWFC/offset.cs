...
namespace XWFC
{
    ...
    {
        public static Vector3[] GetOffsets(int dimensions = 3)
        {
            ...
            var offsets = new Vector3[dimensions * 2];

            for (int i = 0; i < dimensions; i++)
            {
                var offsetPlus = new Vector3(0, 0, 0);
                var offsetMinus = new Vector3(0, 0, 0);
                offsetPlus[i] = 1;
                offsetMinus[i] = -1;
